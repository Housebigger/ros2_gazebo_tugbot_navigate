...
def generate_launch_description():
    ...
    # Phase35-pre: current active candidate world after Phase34 human SLAM/map acceptance.
    # Deprecated scaffold/unscaled/decorative worlds are archived or marked outside the current workflow.
