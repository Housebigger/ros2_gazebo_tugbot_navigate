...
9. GUI+RViz 验收(2026-07-18):run 090603,EXIT_REACHED,oracle 0.000%(0/164),rms median 0.026 / p90 0.070,nan 94/162,0 摔倒;脚本自带 PRIME 默认值生效——gz server 533MiB + gz GUI 639MiB + RViz 全在 4070。用户人工确认 FrontCamera 第一视角画面,验收通过。
