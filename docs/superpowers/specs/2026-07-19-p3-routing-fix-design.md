...
3. **Task 6 重启统计门全录(2026-07-20,修案栈 8 跑)**:4 EXIT(075734/080936/
   ...
   零增长 escape 均 cut_n=0 有据、reverify 候选集逐次证空、0 冻结/exhausted/
   stuck、全部 14 次重开单边出口向、reverify 两跑命中毒边 ((5,4),E) 且重开后
   成功穿越(修案实效在跑内双证)。**诚实边界(不许声称的)**:TIMEOUT 总量无
...
4. **GUI 验收(2026-07-20,两跑)**:首跑 `20260720_160445` = TIMEOUT,判 P1 类
   (oracle 15.186%/15.186%,25 escape、1 次 `divert=reverify` 第四次命中同一毒边
