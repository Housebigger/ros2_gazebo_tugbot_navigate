...
9. **统计门复验(5c 后两跑)**:均 EXIT、oracle **0.000%**(122/122)、零 ERROR、**双混叠门零触发**;体素 **664,737 / 674,185**——从 5c 前的 728/745k 回落**到运动学基线水平**(649-711k),转弯刷厚源被量化消除;通关 ~605s(比 5c 前快 ~11%,与离线预测吻合)。工件:`log/flood_fill_run_20260723_094123`、`_095224`。
