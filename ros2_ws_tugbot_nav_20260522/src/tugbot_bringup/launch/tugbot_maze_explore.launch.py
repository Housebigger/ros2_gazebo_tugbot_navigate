...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('explorer_type', default_value='maze_dfs', description='Explorer implementation: maze_dfs or frontier.'),
        ...
        DeclareLaunchArgument('max_goals', default_value='30', description='Maximum exploration goals.'),
        ...
        DeclareLaunchArgument('branch_goal_step_m', default_value='1.1', description='Preferred DFS branch goal distance.'),
        ...
        DeclareLaunchArgument('near_exit_fallback_enabled', default_value='false', description='Enable Phase27-alt near-exit terminal acceptance / micro-goal fallback; default false preserves baseline behavior.'),
        DeclareLaunchArgument('near_exit_fallback_trigger_radius_m', default_value='0.9', description='Robot-to-exit distance threshold for considering Phase27-alt fallback.'),
        DeclareLaunchArgument('near_exit_terminal_acceptance_radius_m', default_value='0.6', description='Robot-to-exit distance for terminal acceptance fallback.'),
        ...
        DeclareLaunchArgument('near_exit_fallback_max_attempts', default_value='1', description='Maximum near-exit micro-goal fallback attempts per run.'),
        DeclareLaunchArgument('near_exit_fallback_require_clean_topology', default_value='true', description='Require zero blocked branches and zero blacklisted goals before near-exit fallback.'),
        DeclareLaunchArgument('near_exit_fallback_require_path_alignment', default_value='true', description='Require robot-to-path alignment when that diagnostic is available.'),
        ...
        DeclareLaunchArgument('max_failures_per_branch', default_value='2', description='Repeated Nav2 failures before a branch becomes blocked.'),
        DeclareLaunchArgument('max_backtrack_failures_per_node', default_value='2', description='Repeated backtrack failures before skipping a junction.'),
        ...
        TimerAction(period=13.0, actions=[maze_dfs_explorer, frontier_explorer]),
